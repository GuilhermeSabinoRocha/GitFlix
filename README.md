...
Solte a imaginação à vontade, aqui ninguém vai julgar ninguém. Claro que não precisa escrever um livro, mas quanto mais participarmos, mais a história vai ganhando características e volume de um gitflow real.
...
- Abra um arquivo txt/doc, escreva seu trecho, e salve na pasta Gitflix (ou crie uma subpasta) da sua máquina
